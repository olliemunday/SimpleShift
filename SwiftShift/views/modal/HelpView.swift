        ...
        ScrollView {
            LazyVStack(alignment: .leading, spacing: 30) {
                ...
                HCenter {
                    ZStack {
                        HStack(spacing: 16) {
                            ShiftView(id: UUID(), shift: Shift(shift: "08:00 17:00", gradient_1: Color.hex("ffe259"), gradient_2: Color.hex("ffa751")))
                                .frame(width: 80, height: 140)
                                .zIndex(1)
                                .offset(x: activateDragAnimation ? 0 : 96)

                            ShiftView(id: UUID(), shift: Shift(shift: "09:00 18:00", gradient_1: Color.hex("a8e063"), gradient_2: Color.hex("56ab2f")))
                                .frame(width: 80, height: 140)
                                .zIndex(2)
                                .offset(x: activateDragAnimation ? 0 : -96)

                            ShiftView(id: UUID(), shift: Shift(shift: "07:00 19:00", gradient_1: Color.hex("ff6a00"), gradient_2: Color.hex("ee0979")))
                                .frame(width: 80, height: 140)
                        }
