    ...
    var body: some View {
        NavigationStack(path: $navigationStack) {
            List{
                ...
                Section {
                    Button(action: {showPrivacy = true}, label: {ImageLabel(title: String(localized: "privacy"), systemName: "hand.raised.fill", color: .blue)})
                    Button(action: {showHelp = true}, label: {ImageLabel(title: String(localized: "help"), systemName: "questionmark", color: .blue)})
